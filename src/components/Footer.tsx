          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex items-center space-x-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <a
                ...
                onMouseLeave={() => setHoveredSocial(null)}
                className="group flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-xl transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-green-500/25 shimmer-effect"
              >
                {/* WhatsApp SVG Icon */}
